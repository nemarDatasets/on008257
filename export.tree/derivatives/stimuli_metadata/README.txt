...
annotations_fieldnames.json: Descriptions of metadata fields corresponding to the 'annotations.json' file.
...
videos_with_no_audio.csv: Lists of videos with no audio track.
...
Go to this link [https://boldmomentsdataset.csail.mit.edu/stimuli_metadata] to download the stimulus set files and agree to the terms of use: 
